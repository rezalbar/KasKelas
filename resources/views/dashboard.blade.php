...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse mt-3 mt-lg-0" id="navbarNav">
                <ul class="navbar-nav ms-auto align-items-start align-items-lg-center">
                    ...
                    <!-- Menu Dashboard (Semua Orang Bisa Lihat) -->
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('dashboard') ? 'active' : '' }}" href="/dashboard">Dashboard</a>
                    </li>

                    <!-- 👇 INI RAHASIANYA REZA 👇 -->
                    <!-- Cuma Admin yang bisa lihat menu di dalam blok IF ini -->
    ...
    <div class="container" style="margin-top: 100px;">
        <!-- Notifikasi Error (Kalau Joko maksa masuk halaman terlarang) -->
        @if(session('error'))
            ...
            <div class="col-md-6 mb-4">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body text-center p-5">
                        ...
                        @php
                            $target = 50000; // Contoh target
                            // Hitung cuma yang statusnya LUNAS (Pending gak dihitung)
                            $sudahBayar = auth()->user()->pemasukan->where('status', 'lunas')->sum('jumlah');
